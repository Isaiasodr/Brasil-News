...
window.onload = function () {
  newsType.innerHTML = "<h4>Manchetes</h4>";
  fetchHeadlines();
};
...
businessBtn.addEventListener("click", function () {
  newsType.innerHTML = "<h4>Negócios</h4>";
  fetchBusinessNews();
});
...
searchBtn.addEventListener("click", function () {
  newsType.innerHTML = "<h4>Pesquisa: " + newsQuery.value + "</h4>";
  fetchQueryNews();
});
...
const fetchHeadlines = async () => {
  ...
  if (response.status >= 200 && response.status < 300) {
    ...
    newsdetails.innerHTML = "<h5>nennhuma notícia encontrada.</h5>";
    return;
  }
